...
/**
 * Home object for domain model class Orginfo.
 * @see energy.Orginfo
 * @author Hibernate Tools
 */
public class OrginfoHome {

	private static final Log log = LogFactory.getLog(OrginfoHome.class);
	...
	public void persist(Orginfo transientInstance) {
		log.debug("persisting Orginfo instance");
		try {
	...
	public Orginfo merge(Orginfo detachedInstance) {
		...
		try {
			Orginfo result = (Orginfo) sessionFactory.getCurrentSession()
	...
	public Orginfo findById(java.lang.String id) {
		...
		try {
			Orginfo instance = (Orginfo) sessionFactory.getCurrentSession()
					.get("energy.Orginfo", id);
			if (instance == null) {
